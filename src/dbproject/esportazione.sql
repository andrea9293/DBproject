--------------------------------------------------------
--  File creato - luned�-gennaio-23-2017   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  SELECT I.IDPARTITA, I.IDSQ1, ST.SQUADRA, COALESCE(G1.GOAL,0) AS GOL1, COALESCE(G2.GOAL,0) AS GOL2, STAT.SQUADRA, I.IDSQ2, PG.IDTORNEOG, PE.IDTORNEOE, PA.NUMERO_TURNO_TORNEO
  FROM ((((((INCONTRI I INNER JOIN STAT_INDIVIDUALI ST ON I.IDSQ1=ST.IDSQUADRA) INNER JOIN STAT_INDIVIDUALI STAT ON I.IDSQ2=STAT.IDSQUADRA) 
    ...
    LEFT OUTER JOIN (PARTITA PA INNER JOIN GOAL_SQUADRA_PARTITA G3 ON PA.IDPARTITA = G3.IDPARTITA) ON PA.IDPARTITA = I.IDPARTITA
GROUP BY I.IDPARTITA, I.IDSQ1,ST.SQUADRA,G1.GOAL, G2.GOAL, STAT.SQUADRA, I.IDSQ2, PG.IDTORNEOG, PE.IDTORNEOE, PA.NUMERO_TURNO_TORNEO;
--------------------------------------------------------
