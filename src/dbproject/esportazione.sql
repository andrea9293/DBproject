--------------------------------------------------------
--  File creato - domenica-gennaio-22-2017   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  SELECT I.IDPARTITA, I.IDSQ1, ST.SQUADRA, COALESCE(G1.GOAL,0) AS GOL1, COALESCE(G2.GOAL,0) AS GOL2, STAT.SQUADRA, I.IDSQ2, PG.IDTORNEOG, PE.IDTORNEOE, P.NUMERO_TURNO_TORNEO
FROM (((((INCONTRI I INNER JOIN STAT_INDIVIDUALI ST ON I.IDSQ1=ST.IDSQUADRA) INNER JOIN STAT_INDIVIDUALI STAT ON I.IDSQ2=STAT.IDSQUADRA) 
    LEFT OUTER JOIN GOAL_SQUADRA_PARTITA G1 ON I.IDSQ1=G1.IDSQUADRA AND I.IDPARTITA=G1.IDPARTITA) 
    LEFT OUTER JOIN GOAL_SQUADRA_PARTITA G2 ON I.IDSQ2=G2.IDSQUADRA AND I.IDPARTITA=G2.IDPARTITA)
    LEFT OUTER JOIN (PARTECIPANTI_GIRONI PG INNER JOIN PARTITA P ON P.IDTORNEOG = PG.IDTORNEOG) ON P.IDPARTITA = I.IDPARTITA)
    LEFT OUTER JOIN (PARTECIPANTI_ELIMINAZIONE PE INNER JOIN PARTITA P ON P.IDTORNEOE = PE.IDTORNEOE) ON P.IDPARTITA = I.IDPARTITA
GROUP BY I.IDPARTITA, I.IDSQ1,ST.SQUADRA,G1.GOAL, G2.GOAL, STAT.SQUADRA, I.IDSQ2, PG.IDTORNEOG, PE.IDTORNEOE, P.NUMERO_TURNO_TORNEO;
--------------------------------------------------------
...
Insert into ANDREA.INCONTRI (IDPARTITA,IDSQ1,IDSQ2) values ('14','1','2');
Insert into ANDREA.INCONTRI (IDPARTITA,IDSQ1,IDSQ2) values ('15','3','4');
Insert into ANDREA.INCONTRI (IDPARTITA,IDSQ1,IDSQ2) values ('16','1','3');
...
SET DEFINE OFF;
Insert into ANDREA.STAT_INDIVIDUALI (IDGIOCATORE,NOME,COGNOME,IDSQUADRA,SQUADRA,GOAL,TIRI,FALLI,AMMONIZIONI,ESPULSIONI,FUORIGIOCO,ASSIST,TIRIINPORTA) values ('107','Stephan','El Shaarawy','3','Roma','5','1','0','3','0','1','0','0');
...
Insert into ANDREA.STAT_INDIVIDUALI (IDGIOCATORE,NOME,COGNOME,IDSQUADRA,SQUADRA,GOAL,TIRI,FALLI,AMMONIZIONI,ESPULSIONI,FUORIGIOCO,ASSIST,TIRIINPORTA) values ('20','Dries','Mertens','1','Napoli','12','0','0','0','0','0','0','0');
Insert into ANDREA.STAT_INDIVIDUALI (IDGIOCATORE,NOME,COGNOME,IDSQUADRA,SQUADRA,GOAL,TIRI,FALLI,AMMONIZIONI,ESPULSIONI,FUORIGIOCO,ASSIST,TIRIINPORTA) values ('57','Mario','Mandzukic','2','Juventus','1','0','0','0','0','0','0','0');
...
Insert into ANDREA.STAT_INDIVIDUALI (IDGIOCATORE,NOME,COGNOME,IDSQUADRA,SQUADRA,GOAL,TIRI,FALLI,AMMONIZIONI,ESPULSIONI,FUORIGIOCO,ASSIST,TIRIINPORTA) values ('3','Jose Maria','Callejon','1','Napoli','1','0','0','0','0','0','0','0');
...
Insert into ANDREA.STAT_INDIVIDUALI (IDGIOCATORE,NOME,COGNOME,IDSQUADRA,SQUADRA,GOAL,TIRI,FALLI,AMMONIZIONI,ESPULSIONI,FUORIGIOCO,ASSIST,TIRIINPORTA) values ('21','Arkadiusz','Milik','1','Napoli','4','0','0','0','0','0','2','0');
...
Insert into ANDREA.STAT_INDIVIDUALI (IDGIOCATORE,NOME,COGNOME,IDSQUADRA,SQUADRA,GOAL,TIRI,FALLI,AMMONIZIONI,ESPULSIONI,FUORIGIOCO,ASSIST,TIRIINPORTA) values ('11','Marek','Hamsik','1','Napoli','2','0','0','0','0','0','1','0');
...
SET DEFINE OFF;
Insert into ANDREA.VISTA_EVENTI (IDPARTITA,MINUTO,SQUADRA,EVENTO,GIOCATORE) values ('13','90','Napoli','Goal','Hamsik');
Insert into ANDREA.VISTA_EVENTI (IDPARTITA,MINUTO,SQUADRA,EVENTO,GIOCATORE) values ('16','89','Napoli','Goal','Milik');
...
Insert into ANDREA.VISTA_EVENTI (IDPARTITA,MINUTO,SQUADRA,EVENTO,GIOCATORE) values ('13','80','Juventus','Goal','Mandzukic');
...
Insert into ANDREA.VISTA_EVENTI (IDPARTITA,MINUTO,SQUADRA,EVENTO,GIOCATORE) values ('16','56','Roma','Goal','El Shaarawy');
...
Insert into ANDREA.VISTA_EVENTI (IDPARTITA,MINUTO,SQUADRA,EVENTO,GIOCATORE) values ('16','45','Napoli','Assist','Hamsik');
Insert into ANDREA.VISTA_EVENTI (IDPARTITA,MINUTO,SQUADRA,EVENTO,GIOCATORE) values ('16','45','Napoli','Goal','Callejon');
...
Insert into ANDREA.VISTA_EVENTI (IDPARTITA,MINUTO,SQUADRA,EVENTO,GIOCATORE) values ('15','23','Roma','Goal','El Shaarawy');
Insert into ANDREA.VISTA_EVENTI (IDPARTITA,MINUTO,SQUADRA,EVENTO,GIOCATORE) values ('14','23','Napoli','Goal','Mertens');
...
Insert into ANDREA.VISTA_RIS_PARTITE (IDPARTITA,IDSQ1,SQUADRA1,GOL1,GOL2,SQUADRA2,IDSQ2,IDTORNEOG,IDTORNEOE,NUMERO_TURNO) values ('16','1','Napoli','2','1','Roma','3',null,'1',null);
Insert into ANDREA.VISTA_RIS_PARTITE (IDPARTITA,IDSQ1,SQUADRA1,GOL1,GOL2,SQUADRA2,IDSQ2,IDTORNEOG,IDTORNEOE,NUMERO_TURNO) values ('14','1','Napoli','1','0','Juventus','2',null,'1',null);
...
Insert into ANDREA.VISTA_RIS_PARTITE (IDPARTITA,IDSQ1,SQUADRA1,GOL1,GOL2,SQUADRA2,IDSQ2,IDTORNEOG,IDTORNEOE,NUMERO_TURNO) values ('15','3','Roma','1','0','Lazio','4',null,'1',null);
