...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "ANDREA"."GOAL_PARTITA" ("IDGIOCATORE", "IDPARTITA", "NOME", "COGNOME", "GOAL") AS 
  SELECT G.IDgiocatore, E.IDPARTITA, G.Nome, G.Cognome, COUNT(E.IDevento)
	FROM GIOCATORE G JOIN EVENTI E ON G.IDGIOCATORE = E.IDGIOCATORE
	WHERE E.Evento = 'Goal'
GROUP BY  G.IDgiocatore, E.IDPARTITA, G.Nome, G.Cognome;
--------------------------------------------------------
...
Insert into ANDREA.GOAL_INDIVIDUALI (IDGIOCATORE,NOME,COGNOME,GOAL) values ('20','Dries','Mertens','10');
...
SET DEFINE OFF;
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('7','1','Manolo','Gabbiadini','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('20','10','Dries','Mertens','3');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('107','7','Stephan','El Shaarawy','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('41','5','Juan Guillermo','Cuadrado','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('20','9','Dries','Mertens','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('20','3','Dries','Mertens','3');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('48','2','Gonzalo','Higuain','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('118','3','Radja','Nainggolan','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('122','4','Diego','Perotti','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('20','4','Dries','Mertens','2');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('21','2','Arkadiusz','Milik','2');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('107','6','Stephan','El Shaarawy','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('107','4','Stephan','El Shaarawy','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('130','3','Francesco','Totti','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('11','2','Marek','Hamsik','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('20','1','Dries','Mertens','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('38','11','Giorgio','Chiellini','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('62','1','Miralem','Pjanic','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('62','2','Miralem','Pjanic','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('88','11','Sergej','Milinkovic-Savic','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('30','9','Piotr','Zielinski','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('76','9','Alvaro','Gonzalez','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('101','12','Fortuna Dos Santos','Wallace','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('14','1','Luiz','Jorginho','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('21','3','Arkadiusz','Milik','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('38','1','Giorgio','Chiellini','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('48','5','Gonzalo','Higuain','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('78','12','Ciro','Immobile','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('110','5','Alessandro','Florenzi','1');
Insert into ANDREA.GOAL_PARTITA (IDGIOCATORE,IDPARTITA,NOME,COGNOME,GOAL) values ('110','4','Alessandro','Florenzi','1');
...
Insert into ANDREA.STAT_INDIVIDUALI (IDGIOCATORE,NOME,COGNOME,IDSQUADRA,SQUADRA,GOAL,TIRI,FALLI,AMMONIZIONI,ESPULSIONI,FUORIGIOCO,ASSIST,TIRIINPORTA) values ('20','Dries','Mertens','1','Napoli','10','0','0','0','0','0','0','0');
